        ...
        <div className="backdrop-blur-xl border border-slate-800/80 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8">
                      ...
                      >
                        ...
                        <td className="px-4 py-3.5">
                          {isAccepted ? (
                            ...
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-xs font-bold bg-amber-500/10 border border-amber-500/30 text-amber-400 uppercase tracking-wider">
                        ...
                        <td className="px-4 py-3.5 text-right rounded-r-xl">
                          <div className="inline-flex items-center justify-end gap-2">
                            {isPendingState ? (
                              ...
                              <span className="text-xs text-slate-500 font-semibold uppercase tracking-wider italic">
                                Action Completed
                              </span>
                            )}
                          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 mt-6 border-t border-slate-800/80 text-xs text-slate-400 font-medium">
            ...
            <div className="flex items-center gap-2">
              <button className="px-2.5 py-1 rounded bg-[#1e2736] text-slate-400 hover:text-white border border-slate-700/60 disabled:opacity-40">
                &lt;
              </button>
              <button className="px-2.5 py-1 rounded bg-indigo-600 text-white font-bold">
                1
              </button>
              <button className="px-2.5 py-1 rounded bg-[#1e2736] text-slate-400 hover:text-white border border-slate-700/60">
                &gt;
              </button>
            </div>
          </div>
